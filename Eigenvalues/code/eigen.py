...
A = [
    [4 + 2j, 1 + 3j, -2 + 1j, 3 + 4j, 0 + 5j, 6 - 2j, -1 + 1j, 2 + 0j, 1 - 4j, -3 + 2j, 5 + 1j, 0 + 2j, 6 - 1j, -2 - 3j, 4 + 0j],
    [1 + 0j, 2 + 1j, 0 + 2j, -3 + 1j, 4 + 0j, 2 - 3j, 1 + 4j, 3 - 2j, -1 + 5j, 4 + 2j, -1 + 0j, 3 + 3j, -2 - 1j, 0 + 4j, 1 - 2j],
    [-2 + 1j, 0 + 3j, 3 + 0j, 1 - 1j, -1 + 2j, 2 + 1j, -4 - 3j, 2 + 3j, 1 + 1j, 0 - 2j, -5 + 3j, 2 - 2j, 3 + 0j, 1 + 2j, 4 + 4j],
    [3 + 4j, -1 + 2j, 2 - 1j, 4 + 3j, 0 + 1j, 1 + 5j, -3 + 2j, -2 + 0j, 1 + 3j, 0 + 2j, 4 - 4j, 2 + 1j, -1 + 0j, 3 - 2j, 5 + 1j],
    [0 + 5j, 3 + 2j, -1 + 3j, 1 + 4j, 2 + 0j, -2 + 1j, 0 - 4j, -1 + 1j, 3 - 2j, 0 + 5j, 2 + 3j, 4 - 1j, 1 + 1j, 0 - 3j, -1 + 2j],
    [6 - 2j, 2 + 1j, 1 - 4j, -2 + 1j, 4 - 3j, 3 + 5j, 0 + 2j, -1 + 0j, 2 + 1j, -3 + 2j, 1 - 2j, 4 + 3j, -2 + 0j, 5 + 1j, 0 - 1j],
    [-1 + 1j, 1 + 4j, -4 - 3j, -3 + 2j, 0 - 4j, 0 + 2j, 5 + 3j, -1 + 0j, 2 - 1j, 4 + 1j, 3 - 3j, -2 + 2j, 1 + 0j, -1 + 5j, 0 - 2j],
    [2 + 3j, 4 - 1j, 0 + 1j, 1 + 2j, -3 + 0j, 2 - 2j, -5 + 4j, 1 + 1j, -2 + 3j, 0 - 1j, 4 + 5j, -2 + 0j, 1 + 3j, 3 - 4j, -1 + 1j],
    [0 + 4j, 1 + 2j, 2 - 3j, -3 + 1j, 4 + 1j, 5 - 2j, 1 + 0j, -1 + 5j, 3 - 1j, 2 + 3j, 4 + 2j, -1 + 1j, 0 + 2j, 2 - 4j, 3 + 0j],
    [5 - 1j, 2 + 3j, 0 + 4j, -4 + 0j, 3 + 2j, 1 - 5j, 2 + 1j, 4 + 3j, -2 + 0j, 5 + 1j, 3 - 2j, 0 + 4j, -1 + 3j, 1 + 1j, -4 - 3j],
    [-3 + 0j, 5 + 2j, 1 - 3j, 4 + 1j, -2 + 4j, 3 - 5j, 1 + 2j, 2 + 1j, 4 - 1j, 1 + 3j, 2 + 0j, -3 - 2j, 5 + 1j, 0 + 2j, -1 + 1j],
    [4 + 0j, -2 + 1j, 3 + 2j, 1 - 3j, 0 + 4j, 1 + 2j, -4 - 1j, 2 + 1j, 5 - 2j, -3 + 4j, 0 - 1j, 2 + 0j, 1 + 3j, 4 - 1j, 1 + 2j],
    [2 - 3j, 4 + 5j, 1 + 2j, -3 + 1j, 0 + 4j, 3 + 2j, 5 - 1j, -2 + 3j, 1 - 0j, 4 + 2j, 3 + 1j, 0 - 2j, 1 + 1j, 2 + 4j, -1 + 0j],
    [0 + 2j, 1 + 3j, -2 + 1j, 4 - 1j, 1 + 0j, 3 + 5j, -1 - 2j, 2 + 1j, 5 - 3j, 0 + 4j, -3 + 1j, 1 + 2j, 4 + 0j, -2 + 2j, 0 + 3j],
    [6 + 1j, -1 + 2j, 4 - 3j, 2 + 0j, 0 + 5j, 1 + 4j, -2 + 1j, 3 - 2j, 5 + 0j, -1 + 4j, 2 + 3j, 0 - 1j, 3 + 2j, -2 + 5j, 4 + 0j]
]
